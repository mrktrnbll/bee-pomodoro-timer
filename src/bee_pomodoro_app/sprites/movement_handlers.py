...
def is_position_populated(self: list[tuple[int, int]], inserting_x: int, inserting_y: int) -> bool:
...
def add_position_to_populated_positions(self: list[tuple[int]], inserting_x: int, inserting_y: int) -> None:
    """adds a position to the list of populated positions"""
    self.populated_positions.append((inserting_x, inserting_y))

def get_unpopulated_spawn_position(populated_positions: list[tuple[int, int]], screen_width: int, screen_height: int, sprite_width: int, sprite_height: int) -> tuple[int, int]:
    ...
    while True:
        ...
        if not is_position_populated(populated_positions, x, y):
            add_position_to_populated_positions(populated_positions, x, y)
            return x, y